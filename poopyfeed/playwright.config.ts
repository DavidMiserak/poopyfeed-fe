...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /(children|feedings|diapers|naps|sharing|analytics|invite-accept|notifications|feeding-reminders|quick-log|catch-up|pediatrician-summary)\.e2e\.spec\.ts/,
      dependencies: ['setup'],
    },
    {
