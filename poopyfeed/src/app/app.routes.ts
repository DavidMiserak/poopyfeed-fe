...
export const routes: Routes = [
  ...
  },
  {
    ...
    data: {
      description: 'Log in to PoopyFeed to track feedings, diapers, and naps for your baby.',
      showAds: true,
    },
  },
  {
    ...
    data: {
      description:
        'Create a free PoopyFeed account to start tracking your baby’s feedings, diapers, and naps.',
      showAds: true,
    },
  },
  {
  ...
  },
  {
    ...
    data: {
      description: 'Manage your PoopyFeed account, password, and notification preferences.',
      showAds: true,
    },
  },
  {
  ...
  },
  {
    path: 'quick-log/:type',
    canActivate: [authGuard],
    loadComponent: () => import('./quick-log/quick-log-redirect').then((m) => m.QuickLogRedirect),
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        loadComponent: () => import('./children/list/children-list').then((m) => m.ChildrenList),
        title: 'My Children - PoopyFeed',
        data: { description: 'View and manage your baby profiles in PoopyFeed.' },
      },
      {
        path: 'create',
        loadComponent: () => import('./children/form/child-form').then((m) => m.ChildForm),
      ...
      {
        path: ':id/delete',
        loadComponent: () => import('./children/delete/child-delete').then((m) => m.ChildDelete),
        title: 'Delete Baby - PoopyFeed',
      },
      {
        path: ':childId/dashboard',
        loadComponent: () =>
          import('./children/dashboard/child-dashboard').then((m) => m.ChildDashboard),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./children/advanced/child-advanced').then((m) => m.ChildAdvanced),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./children/pediatrician-summary/pediatrician-summary-print/pediatrician-summary-print').then(
            (m) => m.PediatricianSummaryPrintComponent,
          ),
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./features/analytics/analytics-dashboard').then((m) => m.AnalyticsDashboard),
            title: 'Analytics - PoopyFeed',
          },
          {
            path: 'export',
            loadComponent: () =>
              import('./features/analytics/export-page').then((m) => m.ExportPage),
      ...
      },
      {
        ...
        loadComponent: () => import('./features/catch-up/catch-up').then((m) => m.CatchUp),
        title: 'Catch-Up Mode - PoopyFeed',
      },
      {
        path: ':childId/fuss-bus',
        loadComponent: () => import('./features/fuss-bus/fuss-bus').then((m) => m.FussBusComponent),
        title: 'The Fuss Bus - PoopyFeed',
      },
      {
        path: ':childId/timeline',
        loadComponent: () =>
          import('./children/timeline/child-timeline').then((m) => m.ChildTimeline),
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./children/feedings/list/feedings-list').then((m) => m.FeedingsList),
            title: 'Feedings - PoopyFeed',
          },
          {
            path: 'create',
            loadComponent: () =>
              import('./children/feedings/form/feeding-form').then((m) => m.FeedingForm),
          ...
          },
          {
            path: ':id/delete',
            loadComponent: () =>
              import('./children/feedings/delete/feeding-delete').then((m) => m.FeedingDelete),
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./children/diapers/list/diapers-list').then((m) => m.DiapersList),
            title: 'Diaper Changes - PoopyFeed',
          },
          {
            path: 'create',
            loadComponent: () =>
              import('./children/diapers/form/diaper-form').then((m) => m.DiaperForm),
          ...
          },
          {
            path: ':id/delete',
            loadComponent: () =>
              import('./children/diapers/delete/diaper-delete').then((m) => m.DiaperDelete),
      ...
      },
      {
        ...
        children: [
          {
            path: '',
            loadComponent: () => import('./children/naps/list/naps-list').then((m) => m.NapsList),
            title: 'Naps - PoopyFeed',
          },
          {
            path: 'create',
            loadComponent: () => import('./children/naps/form/nap-form').then((m) => m.NapForm),
          ...
          },
          {
            path: ':id/delete',
            loadComponent: () =>
              import('./children/naps/delete/nap-delete').then((m) => m.NapDelete),
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./children/sharing/sharing-manage').then((m) => m.SharingManage),
  ...
  },
  {
    ...
    canActivate: [authGuard],
    loadComponent: () => import('./invites/accept/invite-accept').then((m) => m.InviteAccept),
  ...
  },
  {
    ...
    data: {
      description: 'PoopyFeed privacy policy: how we collect, use, and protect your data.',
      showAds: true,
    },
  },
  {
    path: 'terms',
    loadComponent: () =>
      import('./legal/terms-of-service/terms-of-service').then((m) => m.TermsOfService),
